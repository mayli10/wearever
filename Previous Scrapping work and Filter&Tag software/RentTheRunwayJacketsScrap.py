...
jackets_rtr_dict = {'website_url': "https://www.renttherunway.com/products/clothing/jacket_coat?sort=recommended&_=1554780446770&page={}",
                    ...
                    'price_tuple': ['span', 'product-price__original mobile-rental-price-copy'],
...
RTRJackets = website_scrap_rtr(jackets_rtr_dict)
...
RTRJackets.to_csv(r'C:\Users\Arno Murcia\Desktop\Northwestern University\GitHub\NUVention-B-2019\RTRJackets.csv',index = None, header=True)
RTRJackets.to_json(r'C:\Users\Arno Murcia\Desktop\Northwestern University\GitHub\NUVention-B-2019RTRJackets.json', orient ='table')
