...
export const LandingPage = () => (
  <div>
    ...
    {/*<div className='main-container'>
      <div>
        <div className = 'to_see_how_it_works'>
            <h3>
                <span>
      ...
      <div className='see_how_it_works'>
        ...
        <div className='step1'>
            <img src={browseicon} className='browse_icon'/>
            <span>
                STEP 1
            </span>
            <p>
        ...
        <div className='step2'>
            <img src={geotagicon} className='geotag_icon'/>
            <span>
                STEP 2
            </span>
            <p>
        ...
        <div className='step3'>
            <img src={suitcaseicon} className='suitcase_icon'/>
            <span>
                STEP 3
            </span>
            <p>
        ...
        <div className='continue_as_guest'>
            <Link to="/productlistpage">CONTINUE AS GUEST</Link>
        </div>
      </div>
</div>*/}
  </div>
